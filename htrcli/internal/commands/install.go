...
var installCmd = &cobra.Command{
	Use:   "install",
	Short: "Register htrcli as a Native Messaging host for Chrome or Firefox",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		htrcliPath, err := exec.LookPath("htrcli")
		if err != nil {
			return fmt.Errorf("htrcli not found in PATH: %w", err)
		}
		htrcliPath, _ = filepath.Abs(htrcliPath)
