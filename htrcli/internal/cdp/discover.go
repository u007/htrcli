// Package cdp is a minimal Chrome DevTools Protocol client for the htrcli
...
var ErrNotRunning = errors.New("CDP browser not running — start it with: htrcli browser start")
